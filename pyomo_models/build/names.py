...
class ComponentName(StrEnum):
    ...
    alpha = "alpha"
    xi_cg = "xi_cg"
    xi_prorata = "xi_prorata"
    beta_prorata = "beta_prorata"
    prorata_curtailment_zeta = "prorata_curtailment_zeta"
    ...
    gen_uc_max = "gen_uc_max"
    gen_uc_min = "gen_uc_min"
    gen_SNSP = "gen_SNSP"
    gen_mingen_redispatch_LB = "gen_mingen_redispatch_LB"
    gen_mingen_redispatch_UB = "gen_mingen_redispatch_UB"
    gen_prorata_curtailment_realpower = "gen_prorata_curtailment_realpower"
    gen_prorata_realpower_max_xi = "gen_prorata_realpower_max_xi"
    gen_prorata_realpower_min = "gen_prorata_realpower_min"
    gen_prorata_realpower_min_xi = "gen_prorata_realpower_min_xi"
    gen_prorata_xi_max = "gen_prorata_xi_max"
    gen_prorata_xi_min = "gen_prorata_xi_min"
    gen_prorata_beta = "gen_prorata_beta"
    gen_market_redispatch = "gen_market_redispatch"
    gen_secure_redispatch = "gen_secure_redispatch"
